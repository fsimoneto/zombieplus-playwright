...
test("nao deve logar com email incorreto", async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Felipe Simoneto', 'fnsimoneto.com.br')

  await page.landing.alertHaveText('Email incorreto')
});

test("nao deve logar com nome vazio", async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('', 'fnsimoneto@gmail.com')
...
test("nao deve logar com email vazio", async ({ page }) => {
  await page.landing.visit()
  await page.landing.openLeadModal()
  await page.landing.submitLeadForm('Felipe Simoneto', '')
